    ...
    <div className="audio-shell">
      ...
      <div className="mt-3 flex flex-wrap items-center gap-2">
        ...
        <div className="ml-auto flex gap-2">
          <button type="button" className="button-secondary min-h-10 px-3" onClick={() => void handleDownload()} disabled={downloading}>{downloading ? <LoaderCircle className="h-4 w-4 animate-spin" /> : <Download className="h-4 w-4" />}<span className="hidden sm:inline">{downloading ? "Preparing" : "Download"}</span></button>
          <DropdownMenu.Root>
