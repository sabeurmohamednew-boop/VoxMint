  ...
  return (
    <>
      <header className="mb-6">
        ...
        <p className="mt-1.5 text-sm text-[var(--foreground-secondary)]">Track this month&apos;s active-provider allowance.</p>
      </header>
      <div className="grid gap-5 md:grid-cols-2">
        <UsageMeter label={`${usage.activeProvider === "mock" ? "Demo" : "Cartesia"} characters`} value={usage.charactersUsed} limit={usage.characterLimit} detail={`Allowance period ${usage.periodKey}`} />
        <UsageMeter label="Saved voices" value={usage.voicesUsed} limit={usage.voiceLimit} detail={`${providerLabel} allowance`} />
      </div>
